...
function AllCoursesFilterSelect({ themeList, languageList }) {
  ...
  return (
    <tr>
      ...
      <td>
        <MultiSelect options={themeOptions} className={"courses__theme__select"} />
      </td>
      <td>
        <MultiSelect options={languageOptions} className={"courses__language__select"} />
      </td>
      <td></td>
    </tr>
  );
