  ...
  return(
    <div>
      <div className="pathTitle">
        <h2>skill paths</h2>
        <a href="#">
          <svg height="30" className="logo__e8M1cFSWTIdSGCXrbQtVp logoProAlt__3SRa6insFXIeH4BZEbiWLs"
      ...
      <div className="careerMainDescr">Skill Paths provide a short roadmap to help you master a new job-ready skill.</div>

      <div className="skillBox">
        {Skill.skillPath.map(item =>
          <div key={item.title} className="courseSkillBox">
            <div className="courseImg" style={{backgroundColor: item.bgColor}}>
              <img src={item.img} alt={item.title}/>
            </div>
            <div className="skillCourseDescr">
              <h2>{item.title}</h2>
              <div className="skillDescr careerDescr">{item.descr}</div>
